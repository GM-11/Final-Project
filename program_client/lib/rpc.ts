...
export const mint = (args: MintArgs): TransactionInstruction => {
    ...
    const [gemPubkey] = pda.deriveGemMetadataPDA({
        mint: args.mint,
    }, _programId);
...
export const getGemMetadata = async (
    ...
    return T.decodeGemMetadata(deserialize(T.GemMetadataSchema, buffer.data) as Record<string, unknown>);
}
